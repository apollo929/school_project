...
import DocsLayout from 'src/layouts/DocsLayout'; //more
import MainLayout from 'src/layouts/MainLayout';
// import HomeView from 'src/views/pages/HomeView';//more
        ...
        routes: [
            {
                ...
                exact: true,
                path: '/app/management/students',
                component: lazy(() => import ('src/views/management/StudentListView'))
            }, {
                exact: true,
                path: '/app/management/students/create',
                component: lazy(() => import ('src/views/management/StudentCreateView'))
            }, {
                exact: true,
                path: '/app/management/students/:customerId/edit',
                component: lazy(() => import ('src/views/management/StudentEditView'))
            }, {
                exact: true,
                path: '/app/management/scores',
                component: lazy(() => import ('src/views/management/ScoreListView'))
            },
            // {   exact: true,   path: '/app/management/scores/create',   component:
            // lazy(() => import('src/views/management/CustomerCreateView')) },
            {
                exact: true,
                path: '/app/management/scores/:customerId',
                component: lazy(() => import ('src/views/management/ScoreDetailsView'))
            }, {
                exact: true,
                path: '/app/management/scores/:customerId/edit',
                component: lazy(() => import ('src/views/management/ScoreEditView'))
            }, {
                exact: true,
                ...
                exact: true,
                path: [
                    '/app/chat/new', '/app/chat/:threadKey'
                ],
                ...
                exact: true,
                path: [
                    '/app/mail/label/:customLabel/:mailId?', '/app/mail/:systemLabel/:mailId?'
                ],
